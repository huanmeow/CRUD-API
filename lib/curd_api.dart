...
import 'package:shopgameapi/services/api_service.dart';

class CurdApi extends StatefulWidget {
  const CurdApi({super.key});

  @override
  State<CurdApi> createState() => _CurdApiState();
}

class _CurdApiState extends State<CurdApi> {
